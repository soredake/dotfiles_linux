...
alias build_faudio='cd $HOME/git/PKGBUILDS/faudio-git && makepkg -si'
alias build_vkd3d='cd $HOME/git/PKGBUILDS/vkd3d-git && makepkg -si'
...
alias build_kernel='cd $HOME/git/PKGBUILDS/linux52-tkg && makepkg -si'
