...
alias build_mesa='tkgup; cd $HOME/git/PKGBUILDS/mesa-git && sed -i -e "s/#MESA_WHICH_LLVM=4/MESA_WHICH_LLVM=4/" -e "s/_aco=false/_aco=true/" customization.cfg && makepkg -si'
...
alias build_vulkanheaders='tkgup; cd $HOME/git/PKGBUILDS/vulkan-headers-git && makepkg -si'
alias build_proton='tkgup; cd $HOME/git/PKGBUILDS/proton-tkg && ./proton-tkg.sh'
alias build_mingw='tkgup; cd $HOME/git/PKGBUILDS/mingw && ./mingw-on-arch-automator.sh'
alias build_kernel='tkgup; cd $HOME/git/PKGBUILDS/linux53-tkg && makepkg -si'
alias build_all='build_kernel; build_mesa; build_d9vk; build_dxvk; build_vkd3d; build_wine; build_proton'
