...
wget $g/Argon-/mpv-stats/master/stats.lua $g/mpv-player/mpv/master/TOOLS/lua/{autocrop,autodeint}.lua $g/haasn/gentoo-conf/xor/home/nand/.mpv/scripts/avail/{skipchapters,image}.lua
