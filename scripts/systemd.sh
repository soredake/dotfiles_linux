...
systemctl enable --now NetworkManager-wait-online reflector.timer fstrim.timer linux-modules-cleanup bluetooth thrash-protect radeon-profile-daemon dnscrypt-proxy nscd sshd NetworkManager gamemoded systemd-timesyncd tor cdemu-daemon
