...
sudo dnf install -y https://github.com/rpmsphere/noarch/raw/master/r/rpmsphere-release-37-1.noarch.rpm https://mirrors.rpmfusion.org/{free/fedora/rpmfusion-,nonfree/fedora/rpmfusion-non}free-release-$(rpm -E %fedora).noarch.rpm # TODO: install only https://raw.githubusercontent.com/rpmsphere/x86_64/master/v/vitetris-0.58.0-lp150.6.5.x86_64.rpm from rpmsphere
