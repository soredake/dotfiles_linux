...
# Install my packages
sudo apt install --install-recommends -y ./*.deb adb bleachbit chntpw dolphin-plugins earlyoom filelight fish gamemode gcdemu gimp internetarchive keepassxc lm-sensors lutris mpv network-manager-openvpn plasma-discover-backend-flatpak ppa-purge pulseaudio-modules-b python3-pip qbittorrent qdirstat rclone-browser retroarch safeeyes seahorse steam stow syncplay virtualbox vitetris winehq-staging exe-thumbnailer
sudo snap install code --classic
sudo flatpak remote-add --if-not-exists flathub https://flathub.org/repo/flathub.flatpakrepo
sudo flatpak install -y flathub org.citra_emu.citra org.jdownloader.JDownloader com.viber.Viber com.github.ztefn.haguichi com.spotify.Client com.discordapp.Discord com.github.micahflee.torbrowser-launcher com.mojang.Minecraft com.neatdecisions.Detwinner net.rpcs3.RPCS3 org.telegram.desktop org.freefilesync.FreeFileSync
...
fish -c 'curl -sL https://git.io/fisher | source && fisher install jorgebucaran/fisher rafaelrinaldi/pure'
